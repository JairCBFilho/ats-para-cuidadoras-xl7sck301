routerAdd(
  ...
  (e) => {
    ...
    if (!candidataId || !vagaId) {
      return e.badRequestError('candidataId e vagaId sao obrigatorios')
    }
    ...
    const candidataData = {
      ...
      origem: candidata.getString('origem'),
    }
    ...
    try {
      ...
      const result = $ai.agent('triagem-ia').chat({
        user_id: userId,
        message: message,
      })
      ...
      return e.json(200, { score, justificativa })
    } catch (err) {
